...
class DataPolicy extends Component {
  render() { 
    return ( 
      <div className="container mt-120" id="datapolicy">
        <div className="row">
          <div className="col-12">
            <h1>Datenschutzerklärung</h1>
            <h2>Grundlegendes</h2>
            <p>Diese Datenschutzerklärung soll die Nutzer dieser Website über die Art, den Umfang und den Zweck der Erhebung und Verwendung personenbezogener Daten durch den Websitebetreiber informieren.
            ...
            <p>Diese Website können Sie auch besuchen, ohne Angaben zu Ihrer Person zu machen. Zur Verbesserung unseres Online-Angebotes speichern wir jedoch (ohne Personenbezug) Ihre Zugriffsdaten auf diese Website. Zu diesen Zugriffsdaten gehören z. B. die momentane Uhrzeit, die von Ihnen angeforderte Datei oder Ihre Ip-Adresse. Durch die Anonymisierung der Daten sind Rückschlüsse auf Ihre Person nicht möglich.</p>
